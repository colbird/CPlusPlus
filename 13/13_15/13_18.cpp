...
void displayStrdent(const Student& student){
...
int main(){
    ...
    Student student6("FirstName6", 'F', "LastName1", 60);
    Student student7("FirstName7", 'G', "LastName2", 70);
    Student student8("FirstName8", 'H', "LastName3", 80);
    Student student9("FirstName9", 'I', "LastName4", 90);
    Student student10("FirstName10", 'J', "LastName5", 100);
