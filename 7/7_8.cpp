...
void countLatters(const char [], int []);
...
int main(){
    ...
    // Ininialize the array with random lowercase letters
    createArray(chars);
...
// Count the occurrences of each letter
void countLatters(const char chars[], int counts[]){
